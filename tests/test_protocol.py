...
def test_protocol_markers():
    ...
    observation = Observation(source="t", source_event_id="1", observed_at=now, event_time=now,
        actor="a", event_type="post", text="TASK-ID: job-1234 ACK retry_count=2 heartbeat",
